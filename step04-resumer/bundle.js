...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = new _vue2.default({
	    ...
	    methods: {
	        ...
	        saveUserTodo: function saveUserTodo() {
	            var logedUser = _leancloudStorage2.default.User.current();
	            var todoString = JSON.stringify(this.todoList);
	            logedUser.set("todoList", { todoString: todoString });
	            logedUser.save();
	        },
	        getUserTodo: function getUserTodo() {
	            var logedUser = _leancloudStorage2.default.User.current();
