	...
	var app = new _vue2.default({
	    ...
	    created: function created() {
	        ...
	        window.onbeforeunload = function () {
	            var todoString = JSON.stringify(_this.todoList);
	            var inputString = JSON.stringify(_this.newTodo);
	            window.localStorage.setItem('myTodos', todoString);
	            window.localStorage.setItem('myInput', inputString);
	        };
	        var oldTodoString = window.localStorage.getItem('myTodos');
	        var oldInputString = window.localStorage.getItem('myInput');
	        var oldTodo = JSON.parse(oldTodoString);
	        var oldInput = JSON.parse(oldInputString);
